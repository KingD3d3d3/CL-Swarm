...
S_POINT = vec2(CENTER_POINT.x + RADIUS_INNER, CENTER_POINT.y)  # point of angle_indirect 0 in inner circle
...
class RaceContactListener(contactListener):
    ...
    def BeginContact(self, contact):
        ...
        #
        # if self.env.car == contact.fixtureA.body or self.env.car == contact.fixtureB.body:
        #     print('collision')
        #     self.env.car.collision = True
...
class RaceCircleLeft(object):
    ...
    def gizmo(self):
        pygame.draw.line(self.screen, Color.Magenta, world_to_pixels(CENTER_POINT, SCREEN_HEIGHT, PPM), world_to_pixels(S_POINT + vec2(7, 0), SCREEN_HEIGHT, PPM))
