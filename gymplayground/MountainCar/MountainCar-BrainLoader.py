...
BRAIN_FILE = 'Finished_1078_MountainCar_v0_model.h5'
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='OpenAI Gym MountainCar-v0 Game Solver with DQN')
    ...
    agent = MountainCarAgent(inputCnt, actionCnt, lr=0.001, epsilon_max=0.01, epsilon_min=0.01)
